...
Ein Semaphor *s* ist eine Variable, die einen ganzzahligen Wert hat. Mit Hilfe dieses Semaphores wird eine bestimmte kritische Ressource überwacht.
...
1. Prozess **A** ist in kritischem Abschnitt.
2. Prozess **B** möchte in den kritischen Abschnitt eintreten
3. **B** wird deaktiviert
4. **A** verlässt kritischen Abschnitt und **B** wird aufgeweckt
